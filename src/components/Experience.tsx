  ...
  const experiences = [
    {
      ...
      location: "Toronto, ON",
      description: "• Worked on <span class='text-primary font-bold cursor-pointer hover:text-primary/80 hover:underline transition-colors duration-200' onclick='window.open(\"https://bmorovrai.paralucent.com/en\", \"_blank\")'>Rovr GenAI Insurance Chatbot <span class='inline-block ml-1'>↗</span></span>\n• Developed intelligent, cloud-native applications on <span class='text-primary font-bold'>Microsoft Azure</span>, integrating machine learning models via <span class='text-primary font-bold'>Azure ML</span> for real-time predictions and analytics, improving model prediction accuracy by <span class='text-primary font-bold'>30%</span>\n• Reduced release cycle time by <span class='text-primary font-bold'>50%</span> by automating ML deployment workflows using <span class='text-primary font-bold'>Azure DevOps</span> and <span class='text-primary font-bold'>Terraform</span>\n• Shipped full-stack features end-to-end, building frontend flows and backend APIs that boosted user engagement by <span class='text-primary font-bold'>20%</span> within the first month of launch\n• Accelerated internal developer adoption by <span class='text-primary font-bold'>30%</span> by creating and documenting a <span class='text-primary font-bold'>GraphQL API</span> used by <span class='text-primary font-bold'>5+ teams</span>\n• Debugged live issues in a production system with <span class='text-primary font-bold'>10,000+ real-time users</span>\n• Boosted system performance by <span class='text-primary font-bold'>40%</span> by implementing <span class='text-primary font-bold'>caching strategies</span>, <span class='text-primary font-bold'>database indexing</span>, and <span class='text-primary font-bold'>load balancing</span>\n• Delivered scalable, secure ML-backed services by integrating <span class='text-primary font-bold'>Azure Functions</span>, <span class='text-primary font-bold'>Logic Apps</span>, <span class='text-primary font-bold'>Cosmos DB</span>, and <span class='text-primary font-bold'>Blob Storage</span>\n• Enhanced backend reliability by writing <span class='text-primary font-bold'>100+ unit tests</span>, increasing code stability and test coverage",
      technologies: ["Microsoft Azure", "Azure ML", "Azure DevOps", "Terraform", "GraphQL", "Azure Functions", "Logic Apps", "Cosmos DB", "Blob Storage"],
